...
class CorefNode(ObjectDependencyNode):
    ...
    def __init__(self, custom_dependency_node, coref, preps=[], amods=[],**kwargs):
        ObjectDependencyNode.__init__(self, custom_dependency_node=custom_dependency_node, preps=preps, amods=amods,**kwargs)
